...
public class GUITouchScroll : MonoBehaviour {
    ...
    void OnGUI ()
    {
        ...
        windowRect = new Rect(0, windowMargin.y+(Screen.height/4), 
	...
	void DoWindow (int windowID) 
	{
		...
		Rect rList        = new Rect(0, 0, numRows*rowSize.x, rowSize.y);
		
        scrollPosition = GUI.BeginScrollView (rScrollFrame, scrollPosition, rList, true, false);
